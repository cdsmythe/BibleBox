...
$movie_types = array('mpg','mpeg','avi','asf','mp4','aif','aiff','ram', 'asf','au','3gp','mov');
...
<html lang="en">
    ...
    <link href="/content/css/filelist.css" rel="stylesheet">
...
//	print "<td class='t'>" . $file['file_type']                      . "</td>";
	if ( $display_dl_count ) {
		print "<td class='c'><p style='text-align:center;'>" . $file['counter'] . "</p></td>";
	}
	print "</tr>";
}
...
print "	<!-- UNCOMMENT FOR FOOTER HERE! <div class='script_title'>Librarybox Directory Listing</div>
</div> -->
	</body>
	</html>";
